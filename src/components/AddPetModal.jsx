        ...
        >
          ...
          >
            ...
            <form onSubmit={save} className="mt-4 grid gap-3">
              ...
              {/* Campo de raza con autocompletado */}
              <div>
                ...
                {BREEDS[especie] ? (
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-3 py-2 rounded-xl border border-emerald-200 focus:ring-2 focus:ring-emerald-600"
                    />
                    {filtro && razasDisponibles.length > 0 && (
                      <ul className="absolute z-10 mt-1 w-full bg-white border border-emerald-100 rounded-xl shadow-lg max-h-40 overflow-y-auto">
